		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					<span class="login100-form-title"> Entrar en Minijuegos </span>
					...
					<div class="wrap-input100 validate-input"
						data-validate="Introduzca su contraseña">
					...
					<div class="text-center p-t-12">
						<span class="txt1"> Olvide mis credenciales </span> <a
							class="txt2" href="#"> Usuario / Contraseña? </a>
					</div>

					<div class="text-center p-t-136">
						<a class="txt2" href="/registro"> Crear una cuenta <i
