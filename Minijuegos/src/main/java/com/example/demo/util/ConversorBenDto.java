...
public class ConversorBenDto {
	...
	public ComentariosJuegosDTO ComentariosJuegosDtoToBen(ComentariosJuegosDTO comen) {
	...
	public ComentariosJuegos ComentariosJuegosBenToDto(ComentariosJuegos comen) {
