...
public class ConversorBenDto {
	...
	public PuntuacionesDTO PuntuacionesDtoToBen(Puntuaciones puntuacion) {
	...
	public Puntuaciones PuntuacionesBentoDto(PuntuacionesDTO puntuacion) {
	...
	public ComentariosJuegosDTO ComentariosJuegosBenToDTO(ComentariosJuegosDTO comen) {
	...
	public ComentariosJuegos ComentariosJuegosDTOtoBen(ComentariosJuegos comen) {
